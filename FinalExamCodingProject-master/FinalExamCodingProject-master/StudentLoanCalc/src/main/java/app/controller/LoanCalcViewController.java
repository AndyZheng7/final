...
public class LoanCalcViewController implements Initializable   {
	...
	private void btnCalcLoan(ActionEvent event) {
		...
		double total = calulations(dLoanAmount, dInterestRate, dNbrOfYears);
		
		lbltotalInterest.setText(Double.toString(total) - dLoanAmount);
	...
	private double calulations(double loanAmount, double interestRate, double nbrOfYears) {
